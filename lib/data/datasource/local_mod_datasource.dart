...
//   3. JSON bundled      → assets/db/database_sm64coopdx.json  (fallback).
//
...
class LocalModDatasource {
  ...
  static const String _localFileName = 'database_sm64coopdx.json';
  ...
  Future<List<ModModel>> getAll() async {
  ...
  Future<String> _readRaw() async {
    ...
    return rootBundle.loadString(AppConstants.dbAssetPath);
  }
  ...
  Future<FetchResult> fetchRemote() async {
    try {
      ...
      // Validación mínima: JSON válido con clave "mods"
